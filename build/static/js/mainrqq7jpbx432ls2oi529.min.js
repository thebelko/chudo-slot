!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="./static/js/",__webpack_require__(0)}([function(module,exports,__webpack_require__){(function($){"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function add_counter(){var invervat=2,end=10;start<end?(start+=invervat,$("#js-count").html(start)):(start+=4,$("#js-count").html(start))}function parseTime_bv(timestamp){timestamp<0&&(timestamp=0);var day=Math.floor(timestamp/60/60/24),hour=Math.floor(timestamp/60/60),mins=Math.floor((timestamp-60*hour*60)/60),secs=Math.floor(timestamp-60*hour*60-60*mins),left_hour=Math.floor((timestamp-24*day*60*60)/60/60);$("span.afss_day_bv").text(day),$("span.afss_hours_bv").text(left_hour),String(mins).length>1?$("span.afss_mins_bv").text(mins):$("span.afss_mins_bv").text("0"+mins),String(secs).length>1?$("span.afss_secs_bv").text(secs):$("span.afss_secs_bv").text("0"+secs)}var _polyfills=__webpack_require__(2),_polyfills2=_interopRequireDefault(_polyfills);__webpack_require__(4),$(function(){_polyfills2.default.init()}),$(document).ready(function(){$("#show-more").click(function(){event.preventDefault(),$("#more-slots").slideDown(2e3),$(this).hide()})});var start=1e6,remain_bv=(setInterval(add_counter,3e3),110584);$(document).ready(function(){setInterval(function(){remain_bv-=1,parseTime_bv(remain_bv),remain_bv<=0&&alert("Hello")},1e3)})}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
